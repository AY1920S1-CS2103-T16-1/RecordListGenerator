...
public class DateTime {
    ...
    /**
     * Returns a DateTime with one day added.
     */
    public DateTime addOneDay() {
        LocalDateTime current = LocalDateTime.of(date, time);
        TimeDuration timeDuration = new TimeDuration(24, 0);
        return new DateTime(current.plusHours(timeDuration.getHours()).plusMinutes(timeDuration.getMinutes()));
    }
